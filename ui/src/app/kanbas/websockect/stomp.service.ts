...
export class StompService {
    ...
    public send(message:string){
        ...
        let d=JSON.stringify({'name':message })

        this.stompClient.send("/app/hello", {}, JSON.stringify({'name':message }));
    }
    
    public sendNote(kanbanId:number,noteBlock:NoteBlock){
        this.stompClient.send("/app/kanbans/"+kanbanId, {}, JSON.stringify(noteBlock));
    }
