...
public class SwimlaneController {
    @Autowired
    SwimlaneService swimlaneService;//se encarga de realizar tareas más complejas, como acceder a la base de datos para obtener o guardar entidades Swimlane.
    ...
    /*Maneja una solicitud GET y recibe como parámetro el ID de una entidad Swimlane. Utiliza el servicio SwimlaneService para obtener la entidad Swimlane 
     * de la base de datos y luego utiliza el mapeador SwimlaneMapper para convertirla en un objeto DTO. El método devuelve el DTO como respuesta a la 
     * solicitud.*/
     */
    ...
    /*obtener una lista de swimlanes asociados a un Kanban específico, identificado por su id (kanbanId). Para ello, 
     * se hace uso del servicio swimlaneService y su método findAll, que recibe como parámetro el id del Kanban y 
     * devuelve una lista de objetos de tipo Swimlane*/
     */
    ...
    /*Maneja una solicitud PUT y recibe como parámetros el ID de una entidad Swimlane (si existe), un objeto DTO y 
     * el ID de una entidad Kanban. Utiliza el mapeador SwimlaneMapper para convertir el DTO en una entidad Swimlane y 
     * luego utiliza el servicio SwimlaneService para guardar la entidad en la base de datos.*/
     */
    ...
    /*maneja una solicitud DELETE y recibe como parámetro el ID de una entidad Swimlane. Utiliza el servicio SwimlaneService 
     * para eliminar la entidad de la base de datos. El método no devuelve ninguna respuesta.*/
    ...
    /*maneja una solicitud PUT y recibe como parámetro una lista de objetos DTO y el ID de una entidad Kanban. 
     * Utiliza el mapeador Swimlane para convertir objetos de la clase Swimlane en objetos de la clase SwimlaneDto */
     */
