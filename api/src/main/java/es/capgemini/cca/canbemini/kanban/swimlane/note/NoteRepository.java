...
public interface NoteRepository extends CrudRepository<Note, Long> {
      ...
      * una consulta personalizada que se debe ejecutar para recuperar todas las notas
      *  asociadas a una swimlane específica. La consulta se ejecuta utilizando el
      *  parámetro swimlaneId que se proporciona como entrada al método. El resultado 
      *  de la consulta se devuelve como una lista de objetos Note.
      */
